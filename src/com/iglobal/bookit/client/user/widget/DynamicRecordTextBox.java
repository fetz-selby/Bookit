...
public class DynamicRecordTextBox extends Composite implements IsEntryWidget{
	private DataTypeConstants dataTypeId;
	private String labelName, fieldName, dataType;
	private static DynamicRecordTextBoxUiBinder uiBinder = GWT
			.create(DynamicRecordTextBoxUiBinder.class);

	interface DynamicRecordTextBoxUiBinder extends
			UiBinder<Widget, DynamicRecordTextBox> {
	}

	@UiField LabelElement label;
	@UiField TextBox textBox;
	
	public DynamicRecordTextBox(String labelName, String fieldName, String dataType, DataTypeConstants dataTypeId) {
	...
	private void initComponent(){
		...
		label.setInnerText(Utils.getTruncatedText(labelName, 18));
